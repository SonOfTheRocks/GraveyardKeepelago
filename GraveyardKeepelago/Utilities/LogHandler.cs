...
namespace GraveyardKeepelago.Utilities
{
    public class LogHandler : Logger
    {
        ...
        public override void LogMessage(string message) => _logger.LogMessage(message);
        public override void LogInfo(string message) => _logger.LogInfo(message);
        public override void LogDebug(string message) => _logger.LogDebug(message);
    }
}